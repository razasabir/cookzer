...
// inside the packaged Android/iOS app (window.Capacitor present) — never on
// the real website. styles.css gives scroll containers a much bigger
// safe-area-inset-bottom fallback under that attribute, since a WebView
// that doesn't resolve env(safe-area-inset-bottom) to a real value still
// left content hidden behind the system nav bar even with the smaller
// per-page padding-bottom fallback alone.

...
| Direct messaging | idea | header icon already implies this exists |
| Real backend (data persistence) | idea | blocks most of the above — needs a stack decision, see `coder` skill |
